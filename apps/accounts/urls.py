...
urlpatterns = [
    ...
    path('add_anime_completo/', views.DashboardAddAnimeCompleto, name='DashboardAddAnimeCompleto'),
    path('add_manga/', views.DashboardAddManga, name='DashboardAddManga'),
    path('add_manga_completo/', views.DashboardAddMangaCompleto, name='DashboardAddMangaCompleto'),
